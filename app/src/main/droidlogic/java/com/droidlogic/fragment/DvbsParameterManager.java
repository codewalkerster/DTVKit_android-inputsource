...
public class DvbsParameterManager {
    ...
    public static final int OPERATOR_CANALDIGITAL = 0x0901;
    public static final int OPERATOR_KABELIO = 0x0B00;
    ...
    public static final int OPERATOR_INVALID_BOUQUETID = 0xFFFF;
